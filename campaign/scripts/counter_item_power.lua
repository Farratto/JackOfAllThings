...
--luacheck: globals getCastValue onWheel adjustCounter onChargesChanged onValueChanged calculateTotal calculateUsed
--luacheck: globals calculateUsed getTotalCharges getChargesUsed
